...
public class FuzzyPumpController extends PApplet{
	...
	public void setup(){
		...
		inputVariable1.addTerm(new Trapezoid("tooLow", 0.000, 0.000, 20.000, 30.000));
		inputVariable1.addTerm(new Trapezoid("low", 20.000, 30.000, 45.000, 55.000));
		inputVariable1.addTerm(new Triangle("normal", 40.000, 55.000, 70.000));
		inputVariable1.addTerm(new Trapezoid("high", 55.000, 65.000, 80.000, 90.000));
		inputVariable1.addTerm(new Trapezoid("tooHigh", 80.000, 90.000, 100.000, 100.000));
		...
		ruleBlock.addRule(Rule.parse("if level is tooLow or level is low then command is pumpForward", engine));
		ruleBlock.addRule(Rule.parse("if level is tooHigh level is high or then command is pumpBack", engine));
		ruleBlock.addRule(Rule.parse("if level is normal then command is doNothing", engine));
